...
from libs.models import DeepLabV1_VGG16_MSC, DeepLabV2_VGG16_MSC, DeepLabV1_ResNet101_MSC, DeepLabV2_ResNet101_MSC
...
def train(config_path, cuda):
    ...
    # Model setup
    if CONFIG.MODEL.NAME == "DeepLabV2_ResNet101_MSC":
        model = DeepLabV2_ResNet101_MSC(n_classes=CONFIG.DATASET.N_CLASSES)
    elif CONFIG.MODEL.NAME == "DeepLabV1_ResNet101_MSC":
        model = DeepLabV1_ResNet101_MSC(n_classes=CONFIG.DATASET.N_CLASSES)
    elif CONFIG.MODEL.NAME == "DeepLabV2_VGG16_MSC":
        model = DeepLabV2_VGG16_MSC(n_classes=CONFIG.DATASET.N_CLASSES)
    elif CONFIG.MODEL.NAME == "DeepLabV1_VGG16_MSC":
        model = DeepLabV1_VGG16_MSC(n_classes=CONFIG.DATASET.N_CLASSES)
    else:
        print('Currently support only "DeepLabV2_ResNet101_MSC", \
        "DeepLabV1_ResNet101_MSC", "DeepLabV2_VGG16_MSC", \
        "DeepLabV1_VGG16_MSC"')
...
#        gts += list(gt_labels.numpy())
        preds.append(list(labels.cpu().numpy()))
        gts.append(list(gt_labels.numpy()))
