...
if __name__ == '__main__':
    ...
    parser.add_argument('--datalist', type=str, default='./data/val.txt')
    parser.add_argument('--save_path', type=str)
    parser.add_argument("--att_dir", type=str, default='./runs/exp8/')
    parser.add_argument("--thr", type=list, default=[0.1, 0.15, 0.2, 0.25, 0.3,0.35,0.4,0.45,0.5])
    ...
    with open('./data/voc12/val_cls.txt') as f:
        lines = f.readlines()
