...
from utils.LoadData import test_srcam_data_loader_mp
...
def validate(args, gpu_id):
    ...
    model = model.cuda()
    model.eval()
    val_loader = test_srcam_data_loader_mp(args, args.multi_scale, process_id=gpu_id)
    ...
    with torch.no_grad():
        ...
        for idx, dat in tqdm(enumerate(val_loader)):
            ...
            tensor = np.zeros((81, height, width), np.float32)
